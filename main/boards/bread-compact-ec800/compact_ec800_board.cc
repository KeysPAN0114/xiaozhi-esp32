...
#define TAG "CompactEC800Board"

LV_FONT_DECLARE(font_puhui_14_1);
LV_FONT_DECLARE(font_awesome_14_1);

class CompactEC800Board : public EC800Board {
private:
...
public:
    CompactEC800Board() : EC800Board(EC800_TX_PIN, EC800_RX_PIN, 4096),
...
DECLARE_BOARD(CompactEC800Board);
